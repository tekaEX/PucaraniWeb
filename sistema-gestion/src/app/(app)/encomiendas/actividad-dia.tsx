...
import { Check, X, Phone, Wallet, Truck, CloudOff } from "lucide-react";
...
import { calcularPagoChofer } from "./actions";
import type { EncomiendaActividadTipo, EncomiendaPago } from "@/types/db";
...
export function ActividadDia({
  ...
  const enOrden = [...eventos].sort((a, b) => a.hora.localeCompare(b.hora));
